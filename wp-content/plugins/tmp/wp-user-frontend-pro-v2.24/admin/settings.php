...
class WPUF_Admin_Settings {
    ...
    function admin_menu() {
        ...
        add_submenu_page( 'wpuf-admin-opt', __( 'Registration Forms', 'bediq' ), __( '注册表单', 'bediq' ), $capability, 'edit.php?post_type=wpuf_profile' );
        add_submenu_page( 'wpuf-admin-opt', __( 'Subscription', 'bediq' ), __( '订购', 'bediq' ), $capability, 'edit.php?post_type=wpuf_subscription' );
        add_submenu_page( 'wpuf-admin-opt', __( 'Coupons', 'bediq' ), __( '优惠券', 'bediq' ), $capability, 'edit.php?post_type=wpuf_coupon' );
